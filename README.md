...
```html
<head>
    <script src="[https://cdn.jsdelivr.net/gh/modsLabs/mod-css@main/dist/mod-css.min.js](https://cdn.jsdelivr.net/gh/modsLabs/MOD-CSS-2.0.2@main/MODCSS_2.0.2.min.js)">
</head>
```
